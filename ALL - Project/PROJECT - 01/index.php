...
if (isset($_GET['action']) && $_GET['action'] === 'delete' && isset($_GET['id'])) {
    $result = $studentManager->delete($_GET['id']);
...
function getStatusBadge($status) {
    ...
    return $badges[$status] ?? 'bg-gray-50 text-gray-600 ring-gray-500/10';
}
?>
<!DOCTYPE html>
                ...
                <tbody class="divide-y divide-gray-200">
                  ...
                  <?php else: ?>
                    ...
                    <tr>
                      ...
                      >
                        <span
                          class="inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset <?php echo getStatusBadge($student['status']); ?>"
                          ><?php echo htmlspecialchars($student['status']); ?></span
                        >
                      </td>
                      <td
