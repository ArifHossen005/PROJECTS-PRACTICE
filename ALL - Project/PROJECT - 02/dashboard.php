                    ...
                    <main class="flex-1 p-6 lg:p-8">
                              ...
                              <div
                                        ...
                                        <div class="flex items-center space-x-4 mt-4 md:mt-0">
                                                  <button onclick="window.location.href='logout.php'" class="flex items-center space-x-2 px-4 py-2 bg-white border border-gray-200 rounded-lg text-gray-600 hover:text-indigo-600 hover:border-indigo-600 transition-all duration-200">
                                                  ...
                                                  <div class="p-6">
                                                            <div class="flex flex-col md:flex-row md:items-center">
                                                                      ...
                                                                      <div class="mt-4 md:mt-0 md:ml-6 flex-1">
                                                                                <h3 class="text-xl font-bold text-gray-800"><?php echo htmlspecialchars($user->name); ?></h3>
                                                                      </div>
                                                            </div>
